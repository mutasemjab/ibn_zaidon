...
<div class="page-header d-flex align-items-start justify-content-between flex-wrap gap-3">
    <div>
        ...
        <p class="page-sub"><?php echo e($exam->questions->count()); ?> <?php echo e(__('messages.questions')); ?> · <?php echo e($exam->duration_minutes); ?> <?php echo e(__('messages.min_label')); ?> · <?php echo e(__('messages.pass_of_total')); ?>: <?php echo e($exam->pass_marks); ?>/<?php echo e($exam->total_marks); ?></p>
    </div>
    <div class="d-flex gap-2">
        <a href="<?php echo e(route('admin.exams.edit', $exam->id)); ?>" class="btn-outline-sm"><i class="bi bi-pencil"></i> <?php echo e(__('messages.Edit')); ?></a>
...
<div class="row g-3">
    ...
    <div class="col-12 col-xl-7">
        <div class="panel-card">
            <div class="panel-card-header">
                <h2 class="panel-card-title"><?php echo e(__('messages.questions')); ?> (<?php echo e($exam->questions->count()); ?>)</h2>
            </div>
            <div class="panel-card-body">
                ...
                <div class="mb-4 pb-3" style="border-bottom:1px solid var(--border)">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        ...
                        <div class="d-flex gap-1" style="flex-shrink:0">
                            ...
                            <form action="<?php echo e(route('admin.exams.questions.destroy', $q->id)); ?>" method="POST" onsubmit="return confirm('<?php echo e(__('messages.delete_question_confirm')); ?>')">
                    ...
                    <div class="d-flex gap-2 mb-2">
                        <span class="pill pill-neutral"><?php echo e(__('messages.'.($q->question_type === 'true_false' ? 'true_false' : ($q->question_type === 'short_answer' ? 'short_answer' : 'mcq')))); ?></span>
                        <span class="pill pill-info"><?php echo e($q->marks); ?> <?php echo e($q->marks > 1 ? __('messages.marks_suffix') : __('messages.mark_suffix')); ?></span>
                        <span class="pill pill-<?php echo e($q->difficulty === 'easy' ? 'success' : ($q->difficulty === 'hard' ? 'warning' : 'neutral')); ?>"><?php echo e(__('messages.'.$q->difficulty)); ?></span>
                    </div>
                ...
                <p style="color:var(--muted)"><?php echo e(__('messages.no_questions_yet_add')); ?></p>
                <?php endif; ?>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-xl-5">
        <div class="panel-card">
            <div class="panel-card-header"><h2 class="panel-card-title"><?php echo e(__('messages.add_question')); ?></h2></div>
            <div class="panel-card-body">
                <form action="<?php echo e(route('admin.exams.questions.store', $exam->id)); ?>" method="POST" enctype="multipart/form-data" id="question-form">
                <?php echo csrf_field(); ?>
                    <div class="mb-3">
                        <label class="form-label"><?php echo e(__('messages.question_ar')); ?> <span class="text-danger">*</span></label>
                    ...
                    <div class="row g-2 mb-3">
                        <div class="col-md-4">
                            <label class="form-label"><?php echo e(__('messages.type_label')); ?></label>
                            <select name="question_type" class="form-select form-select-sm" onchange="toggleOptions('', this.value)">
                                <option value="mcq"><?php echo e(__('messages.mcq')); ?></option>
                                <option value="true_false"><?php echo e(__('messages.true_false')); ?></option>
                                <option value="short_answer"><?php echo e(__('messages.short_answer')); ?></option>
                            </select>
                        </div>
                        <div class="col-md-4">
                            ...
                            <select name="difficulty" class="form-select form-select-sm">
                                ...
                                <option value="medium" selected><?php echo e(__('messages.medium')); ?></option>
                                <option value="hard"><?php echo e(__('messages.hard')); ?></option>
                            </select>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label"><?php echo e(__('messages.marks_label')); ?></label>
                    ...
                    <div id="options-section">
                        <label class="form-label"><?php echo e(__('messages.options_label')); ?></label>
                        ...
                        <div id="mcq-rows" data-next-index="4">
                            ...
                            <div class="option-row d-flex align-items-center gap-2 mb-2">
                                ...
                                <input type="text" name="options[<?php echo e($i); ?>][text_ar]" class="form-control form-control-sm symbol-target" placeholder="<?php echo e(str_replace(':n', $i+1, __('messages.option_ar'))); ?>" dir="rtl">
                                <input type="text" name="options[<?php echo e($i); ?>][text_en]" class="form-control form-control-sm symbol-target" placeholder="<?php echo e(__('messages.option_en')); ?>">
                    ...
                    <div class="mb-3">
                        <label class="form-label"><?php echo e(__('messages.explanation_ar')); ?></label>
                    ...
                    <button type="submit" class="btn-primary-sm w-100 justify-content-center">
                        <i class="bi bi-plus-circle"></i> <?php echo e(__('messages.add_question')); ?>
...
<div class="modal fade" id="editQuestionModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-scrollable">
    <div class="modal-content">
      <form id="edit-question-form" method="POST" enctype="multipart/form-data" data-url-template="<?php echo e(url('admin/questions/__ID__')); ?>">
        <?php echo csrf_field(); ?>
...
function optionRowHtml(prefix, index, textAr, textEn, correct) {
    return '' +
        '<div class="option-row d-flex align-items-center gap-2 mb-2">' +
            ...
            '<input type="text" name="options[' + index + '][text_en]" class="form-control form-control-sm symbol-target" placeholder="<?php echo e(__('messages.option_en')); ?>" value="' + (textEn || '').replace(/"/g, '&quot;') + '">' +
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\zaidon\resources\views\admin\exams\show.blade.php ENDPATH**/ ?>