...
<div class="print-header">
  ...
  <p><?php echo e(now()->format('Y/m/d H:i')); ?> — إجمالي: <?php echo e($cardNumbers->count()); ?> رقم</p>
</div>
...
<?php else: ?>
  ...
  <?php $__currentLoopData = $grouped; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cardName => $numbers): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="group-title">
      <?php echo e($cardName); ?>

      <span style="font-weight:400;font-size:11px;opacity:.8">(<?php echo e($numbers->count()); ?> رقم)</span>
    </div>

    <div class="cards-grid">
      <?php $__currentLoopData = $numbers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div class="card-item">
        <div class="num"><?php echo e($cn->number); ?></div>
        <div class="meta">
          <span class="pill <?php echo e($cn->activate === 1 ? 'pill-active' : 'pill-inactive'); ?>">
            <?php echo e($cn->activate === 1 ? 'مفعّل' : 'غير مفعّل'); ?>

          </span>
          <span class="pill <?php echo e($cn->status === 2 ? 'pill-free' : 'pill-used'); ?>">
            <?php echo e($cn->status === 2 ? 'غير مستخدم' : 'مستخدم'); ?>

          </span>
          <span class="pill <?php echo e($cn->sell === 2 ? 'pill-free' : 'pill-sold'); ?>">
            <?php echo e($cn->sell === 2 ? 'غير مباع' : 'مباع'); ?>

          </span>
        </div>
        <?php if($cn->assignedUser): ?>
        <div style="font-size:10px;color:#555;margin-top:4px"><?php echo e($cn->assignedUser->name); ?></div>
        <?php endif; ?>
      </div>
  ...
  <div class="summary">
    <span>إجمالي الأرقام: <strong><?php echo e($cardNumbers->count()); ?></strong></span>
    <span>غير مستخدمة: <strong><?php echo e($cardNumbers->where('status', 2)->count()); ?></strong></span>
    <span>مستخدمة: <strong><?php echo e($cardNumbers->where('status', 1)->count()); ?></strong></span>
    <span>مفعّلة: <strong><?php echo e($cardNumbers->where('activate', 1)->count()); ?></strong></span>
  </div>
...
<?php /**PATH C:\xampp\htdocs\zaidon\resources\views\admin\card_numbers\print.blade.php ENDPATH**/ ?>