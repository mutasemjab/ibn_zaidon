    ...
    <div class="navbar-end">
        ...
        <div class="dropdown">
            <div class="user-menu" data-bs-toggle="dropdown" aria-expanded="false">
                <div class="user-avatar"><?php echo e($adminLetter); ?></div>

                <div class="user-info">
                    <span class="user-name"><?php echo e($adminName); ?></span>
                    <span class="user-role"><?php echo e($adminRole); ?></span>
                </div>
            ...
            <ul class="dropdown-menu dropdown-menu-end shadow-sm border"
                ...
                <li>
                    <a class="dropdown-item d-flex align-items-center gap-2 py-2"
                       href="<?php echo e(route('admin.login.edit', $authAdmin?->id)); ?>">
...
<?php /**PATH C:\xampp\htdocs\zaidon\resources\views\admin\includes\navbar.blade.php ENDPATH**/ ?>