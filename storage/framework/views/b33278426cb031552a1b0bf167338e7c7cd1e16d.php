...
<?php $__env->startSection('title', __('messages.add_pos')); ?>

<?php $__env->startSection('content'); ?>

<div class="page-header d-flex align-items-start justify-content-between flex-wrap gap-3">
    <div><h1 class="page-title"><?php echo e(__('messages.add_pos')); ?></h1></div>
...
<form action="<?php echo e(route('admin.pos.store')); ?>" method="POST">
<?php echo csrf_field(); ?>
<div class="panel-card">
    <div class="panel-card-header"><h2 class="panel-card-title"><?php echo e(__('messages.pos_info')); ?></h2></div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-12">
                ...
                <input type="url" name="google_map_link" value="<?php echo e(old('google_map_link')); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-12">
                <button type="submit" class="btn-primary-sm"><i class="bi bi-save"></i> <?php echo e(__('messages.save_pos')); ?></button>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\zaidon\resources\views\admin\pos\create.blade.php ENDPATH**/ ?>