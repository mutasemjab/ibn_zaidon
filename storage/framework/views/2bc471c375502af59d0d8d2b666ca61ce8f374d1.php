...
<?php $__env->startSection('title', 'إضافة بانر'); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-6">
                ...
                <input type="number" name="order_index" value="<?php echo e(old('order_index', 0)); ?>"
            ...
            <div class="col-md-6 d-flex align-items-center">
                <div class="form-check form-switch mt-3">
                    <input class="form-check-input" type="checkbox" name="is_active" value="1"
                           id="is_active" <?php if(old('is_active', true)): echo 'checked'; endif; ?>>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\zaidon\resources\views\admin\banners\create.blade.php ENDPATH**/ ?>