...
<div class="r-panel">
    <div class="r-wrap">
        ...
        <form method="POST" action="<?php echo e(route('teacher.login')); ?>" autocomplete="off">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-group">
                ...
                <div class="input-wrap">
                    ...
                    <input
                        ...
                        name="national_id"
                        type="text"
                        class="form-input <?php echo e($errors->has('national_id') ? 'is-invalid' : ''); ?>"
...
unset($__errorArgs, $__bag); ?>
        ...
        <a href="<?php echo e(route('admin.showlogin')); ?>" class="link-admin">
            <i class="bi bi-shield-check"></i> Admin Login
        </a>

        <div class="r-footer">
            &copy; <?php echo e(date('Y')); ?> Ibn Zaidon. Empowering educators everywhere.
        </div>
...
<?php /**PATH C:\xampp\htdocs\zaidon\resources\views\teacher\auth\login.blade.php ENDPATH**/ ?>