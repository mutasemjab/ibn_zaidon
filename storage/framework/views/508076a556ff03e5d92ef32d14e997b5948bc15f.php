...
<div class="page-header d-flex align-items-start justify-content-between flex-wrap gap-3">
    ...
    <a href="<?php echo e(route('teacher.courses.show', $course->id)); ?>" class="btn-outline-sm">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div style="font-size:.75rem;color:var(--muted)"><?php echo e($student->phone ?? ''); ?></div>
                    </td>
                    <td>
...
<?php echo $__env->make('teacher.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\zaidon\resources\views\teacher\courses\progress.blade.php ENDPATH**/ ?>