...
<?php $__env->startSection('title', __('front.py_page_header')); ?>
...
<div style="background:linear-gradient(135deg,var(--z-primary),#1a4ab0);padding:2.5rem 0">
    <div class="container">
        <div class="z-breadcrumb mb-2">
            ...
            <span class="sep">/</span>
            <span><?php echo e(__('front.py_page_header')); ?></span>
        </div>
        <h1 style="color:#fff;font-size:clamp(1.5rem,3vw,2rem);margin:0">
            <i class="bi bi-calendar-check me-2"></i><?php echo e(__('front.py_page_header')); ?>
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-3">
            ...
            <div class="courses-sidebar" id="coursesSidebar">
                ...
                <form method="GET" action="<?php echo e(route('previous-years.index')); ?>">
                    <div class="mb-3">
                    ...
                    <div class="mb-4">
                        <label class="z-label"><?php echo e(__('front.py_filter_year')); ?></label>
                        <select name="year" class="z-select z-input">
                            <option value=""><?php echo e(__('front.py_all_years')); ?></option>
                    ...
                    <?php if(request()->hasAny(['q','subject','year'])): ?>
                        <a href="<?php echo e(route('previous-years.index')); ?>" class="btn-z btn-z-outline btn-z-block mt-2">
        ...
        <div class="col-lg-9">
            <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
                <span style="color:var(--z-text-muted);font-size:.9rem">
                    <strong style="color:var(--z-primary)"><?php echo e($items->total()); ?></strong> <?php echo e(__('front.py_count_suffix')); ?>
            ...
            <?php if($items->isEmpty()): ?>
                <div class="text-center py-5">
                    ...
                    <h5 style="color:var(--z-text-muted);margin-top:1rem"><?php echo e(__('front.py_no_results')); ?></h5>
                </div>
            <?php else: ?>
                <div class="row g-4">
...
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\zaidon\resources\views\front\previous-years.blade.php ENDPATH**/ ?>