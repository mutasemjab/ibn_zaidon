...
<div class="page-header d-flex align-items-start justify-content-between flex-wrap gap-3">
    <div>
        <h1 class="page-title"><?php echo e(__('messages.add_worksheet')); ?></h1>
    </div>
...
<form action="<?php echo e(route('admin.worksheets.store')); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="row g-3">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <select name="status" class="form-control">
                                <option value="1" <?php echo e(old('status', 1) == 1 ? 'selected' : ''); ?>><?php echo e(__('messages.Active')); ?></option>
                                <option value="0" <?php echo e(old('status') == 0 ? 'selected' : ''); ?>><?php echo e(__('messages.Inactive')); ?></option>
                            </select>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\zaidon\resources\views\admin\worksheets\create.blade.php ENDPATH**/ ?>