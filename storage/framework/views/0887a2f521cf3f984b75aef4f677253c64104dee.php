...
<?php $__env->startSection('title', __('messages.t_edit_course')); ?>

<?php $__env->startSection('content'); ?>

<div class="page-header d-flex align-items-start justify-content-between flex-wrap gap-3">
    <div><h1 class="page-title"><?php echo e(__('messages.t_edit_course')); ?></h1></div>
    <div class="d-flex gap-2">
        <a href="<?php echo e(route('teacher.courses.show', $course->id)); ?>" class="btn-outline-sm"><i class="bi bi-layout-text-sidebar"></i> <?php echo e(__('messages.t_manage')); ?></a>
            ...
            <div class="panel-card-body">
                <div class="mb-3">
                    ...
                    <select name="category_id" class="form-select" required>
                        ...
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($cat->id); ?>" <?php if(old('category_id', $course->category_id) == $cat->id): echo 'selected'; endif; ?>><?php echo e($cat->full_path); ?></option>
                ...
                <div class="mb-3">
                    ...
                    <select name="subject_id" class="form-select">
                        ...
                        <?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($sub->id); ?>" <?php if(old('subject_id', $course->subject_id) == $sub->id): echo 'selected'; endif; ?>><?php echo e($sub->full_path); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div class="mb-3">
                    ...
                    <select name="difficulty_level" class="form-select">
                        <?php $__currentLoopData = ['beginner','intermediate','advanced']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($l); ?>" <?php if(old('difficulty_level', $course->difficulty_level) === $l): echo 'selected'; endif; ?>><?php echo e(ucfirst($l)); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div class="row g-2 mb-3">
                    <div class="col-6">
                        ...
                        <input type="number" name="price" value="<?php echo e(old('price', $course->price)); ?>" min="0" step="0.01" class="form-control">
                    </div>
                    <div class="col-6">
                ...
                <div class="form-check form-switch mb-2">
                    <input class="form-check-input" type="checkbox" name="is_published" value="1" id="is_published" <?php if($course->is_published): echo 'checked'; endif; ?>>
                    <label class="form-check-label" for="is_published"><?php echo e(__('messages.t_published')); ?></label>
                </div>
                <div class="form-check form-switch mb-2">
                    <input class="form-check-input" type="checkbox" name="is_free" value="1" id="is_free" <?php if($course->is_free): echo 'checked'; endif; ?>>
                    <label class="form-check-label" for="is_free"><?php echo e(__('messages.t_free_course')); ?></label>
                </div>
                <div class="form-check form-switch mb-3">
                    <input class="form-check-input" type="checkbox" name="sequential_videos" value="1" id="sequential_videos" <?php if($course->sequential_videos): echo 'checked'; endif; ?>>
                ...
                <div class="mb-2">
                    <img src="<?php echo e(asset('uploads/courses/'.$course->thumbnail)); ?>" style="width:100%;height:120px;object-fit:cover;border-radius:8px">
                </div>
                <?php endif; ?>
                ...
                <button type="submit" class="btn-primary-sm w-100 justify-content-center">
                    <i class="bi bi-save"></i> <?php echo e(__('messages.t_save_changes')); ?>
...
<?php echo $__env->make('teacher.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\zaidon\resources\views\teacher\courses\edit.blade.php ENDPATH**/ ?>