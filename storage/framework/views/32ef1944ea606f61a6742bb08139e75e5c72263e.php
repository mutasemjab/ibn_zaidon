...
<div class="card">
    <div class="card-header d-flex justify-content-between">
        ...
        <a href="<?php echo e(route('admin.question-banks.create')); ?>"
    ...
    <div class="card-body">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <?php $__currentLoopData = $questionBanks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo e(asset('assets/uploads/questionBank/'.$exam->pdf_file)); ?>"
                               target="_blank">
                        ...
                        <td>
                            ...
                            <a href="<?php echo e(route('admin.question-banks.edit',$exam->id)); ?>"
                            ...
                            <form method="POST"
                                  action="<?php echo e(route('admin.question-banks.destroy',$exam->id)); ?>"
        ...
        <?php echo e($questionBanks->links()); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\zaidon\resources\views\admin\question_banks\index.blade.php ENDPATH**/ ?>