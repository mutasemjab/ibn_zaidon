...
<div class="page-header d-flex align-items-start justify-content-between flex-wrap gap-3">
    <div><h1 class="page-title"><?php echo e(__('messages.edit_exam')); ?></h1></div>
    <div class="d-flex gap-2">
        <a href="<?php echo e(route('admin.exams.show', $exam->id)); ?>" class="btn-outline-sm"><i class="bi bi-list-check"></i> <?php echo e(__('messages.questions')); ?></a>
...
unset($__errorArgs, $__bag); ?>" required>
                    <?php $__currentLoopData = ['mock','unit','final','practice','previous_years','placement']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($type); ?>" <?php if(old('exam_type', $exam->exam_type) === $type): echo 'selected'; endif; ?>><?php echo e(__('messages.'.$type)); ?></option>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-4">
                ...
                <select name="difficulty_level" class="form-select">
                    <?php $__currentLoopData = ['easy','medium','hard','mixed']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($d); ?>" <?php if(old('difficulty_level', $exam->difficulty_level) === $d): echo 'selected'; endif; ?>><?php echo e(__('messages.'.$d)); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <div class="col-md-4">
                ...
                <select name="course_id" id="courseSelect" class="form-select">
                    ...
                    <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($c->id); ?>" <?php if(old('course_id', $exam->course_id) == $c->id): echo 'selected'; endif; ?>><?php echo e(Str::limit($c->title_en ?: $c->title_ar, 35)); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <select name="teacher_id" id="teacherSelect" class="form-select">
                    ...
                    <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($t->id); ?>" <?php if(old('teacher_id', $exam->teacher_id) == $t->id): echo 'selected'; endif; ?>><?php echo e($t->name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            ...
            ?>
            <div class="col-12" id="placementPanel" style="<?php echo e($exam->course_id ? '' : 'display:none;'); ?>">
                <div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:10px;padding:16px;">
                    ...
                    <div class="d-flex flex-wrap gap-3 mb-3">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="placement_type" id="pt_course" value="course" <?php if($currentPlacement === 'course'): echo 'checked'; endif; ?> onchange="updatePlacementUI()">
                            <label class="form-check-label" for="pt_course"><?php echo e(__('messages.placement_course_level')); ?></label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="placement_type" id="pt_unit" value="unit" <?php if($currentPlacement === 'unit'): echo 'checked'; endif; ?> onchange="updatePlacementUI()">
                            <label class="form-check-label" for="pt_unit"><?php echo e(__('messages.placement_after_unit')); ?></label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="placement_type" id="pt_lesson" value="lesson" <?php if($currentPlacement === 'lesson'): echo 'checked'; endif; ?> onchange="updatePlacementUI()">
                    ...
                    <div class="row g-2" id="placementSelects">
                        <div class="col-md-6" id="unitSelectWrap" style="<?php echo e(($currentPlacement === 'unit' || $currentPlacement === 'lesson') ? '' : 'display:none;'); ?>">
                        ...
                        <div class="col-md-6" id="lessonSelectWrap" style="<?php echo e($currentPlacement === 'lesson' ? '' : 'display:none;'); ?>">
...
const initUnitId   = '<?php echo e(old("unit_id", $exam->unit_id)); ?>';
const initLessonId = '<?php echo e(old("lesson_id", $exam->lesson_id)); ?>';
...
const initSubjectId = '<?php echo e(old("subject_id", $exam->subject_id)); ?>';
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\zaidon\resources\views\admin\exams\edit.blade.php ENDPATH**/ ?>