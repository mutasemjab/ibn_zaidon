...
<div class="page-header d-flex align-items-start justify-content-between flex-wrap gap-3">
    <div>
        <h1 class="page-title"><?php echo e(__('messages.add_course')); ?></h1>
        <p class="page-sub"><?php echo e(__('messages.create_course_desc')); ?></p>
    </div>
        ...
        <div class="panel-card mb-3">
            ...
            <div class="panel-card-body">
                <div class="form-check form-switch mb-2">
                    <input class="form-check-input" type="checkbox" name="is_published" value="1" id="is_published" <?php echo e(old('is_published') ? 'checked' : ''); ?>>
                    <label class="form-check-label" for="is_published"><?php echo e(__('messages.published')); ?></label>
                </div>
                <div class="form-check form-switch mb-2">
                    <input class="form-check-input" type="checkbox" name="is_featured" value="1" id="is_featured" <?php echo e(old('is_featured') ? 'checked' : ''); ?>>
                    <label class="form-check-label" for="is_featured"><?php echo e(__('messages.featured')); ?></label>
                </div>
                <div class="form-check form-switch mb-2">
                    <input class="form-check-input" type="checkbox" name="is_free" value="1" id="is_free" <?php echo e(old('is_free') ? 'checked' : ''); ?>>
                    <label class="form-check-label" for="is_free"><?php echo e(__('messages.free_course')); ?></label>
                </div>
                <div class="form-check form-switch mb-2">
                    <input class="form-check-input" type="checkbox" name="sequential_videos" value="1" id="sequential_videos" <?php echo e(old('sequential_videos') ? 'checked' : ''); ?>>
                ...
                <button type="submit" class="btn-primary-sm w-100 mt-3 justify-content-center">
                    <i class="bi bi-save"></i> <?php echo e(__('messages.save_course')); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <select name="subject_id" class="form-select" id="subjectSelect" onchange="syncCategoryFromSubject(this)">
                        ...
                        <?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($sub->id); ?>"
                                    ...
                                    <?php if(old('subject_id') == $sub->id): echo 'selected'; endif; ?>>
                ...
                <div class="mb-3">
                    ...
                    <select name="difficulty_level" class="form-select">
                        <option value="beginner" <?php if(old('difficulty_level') === 'beginner'): echo 'selected'; endif; ?>><?php echo e(__('messages.beginner')); ?></option>
                        <option value="intermediate" <?php if(old('difficulty_level') === 'intermediate'): echo 'selected'; endif; ?>><?php echo e(__('messages.intermediate')); ?></option>
                        <option value="advanced" <?php if(old('difficulty_level') === 'advanced'): echo 'selected'; endif; ?>><?php echo e(__('messages.advanced')); ?></option>
                    </select>
                </div>
                <div class="row g-2">
                    <div class="col-6">
                        <label class="form-label"><?php echo e(__('messages.price_usd')); ?> <span class="text-danger">*</span></label>
                        <input type="number" name="price" value="<?php echo e(old('price', 0)); ?>" min="0" step="0.01" class="form-control <?php $__errorArgs = ['price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="panel-card">
            ...
            <div class="panel-card-body">
                ...
                <small class="text-muted"><?php echo e(__('messages.thumbnail_hint')); ?></small>
            </div>
        </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\zaidon\resources\views\admin\courses\create.blade.php ENDPATH**/ ?>