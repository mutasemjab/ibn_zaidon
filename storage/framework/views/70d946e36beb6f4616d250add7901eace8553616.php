...
<?php $__env->startSection('title', 'تعديل الدور: ' . $role->name); ?>
...
<div class="page-header d-flex align-items-start justify-content-between flex-wrap gap-3">
    <div>
        ...
        <p class="page-sub"><?php echo e($role->name); ?></p>
    </div>
                        ...
                        <?php $__currentLoopData = $groupPerms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $perm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <label class="perm-item">
                                <input type="checkbox" name="perms[]"
                                       value="<?php echo e($permId); ?>"
                                       class="perm-checkbox group-<?php echo e(Str::slug($groupName)); ?>"
                                       <?php echo e(in_array($permId, $checkedPerms) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\zaidon\resources\views\admin\roles\edit.blade.php ENDPATH**/ ?>