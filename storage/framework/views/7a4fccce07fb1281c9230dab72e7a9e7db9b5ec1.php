...
<div class="page-header d-flex align-items-start justify-content-between flex-wrap gap-3">
    ...
    <a href="<?php echo e(route('teacher.worksheets.create')); ?>" class="btn-primary-sm">
            ...
            <table class="table table-bordered mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo e(route('teacher.worksheets.edit', $ws->id)); ?>" class="btn btn-warning btn-sm">
                                <?php echo e(__('messages.Edit')); ?>

                            </a>
                            <form method="POST" action="<?php echo e(route('teacher.worksheets.destroy', $ws->id)); ?>" style="display:inline-block">
...
<?php echo $__env->make('teacher.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\zaidon\resources\views\teacher\worksheets\index.blade.php ENDPATH**/ ?>