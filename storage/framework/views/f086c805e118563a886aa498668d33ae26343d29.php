...
<div class="page-header d-flex align-items-start justify-content-between flex-wrap gap-3">
    <div><h1 class="page-title"><?php echo e(__('messages.add_previous_year_exam')); ?></h1></div>
...
<form action="<?php echo e(route('teacher.previous-year-exams.store')); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="row g-3">
                ...
                <div class="panel-card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-6">
                            ...
                            <input type="number" name="year" class="form-control" value="<?php echo e(old('year', date('Y'))); ?>" min="1900" max="2100">
                        </div>
                        <div class="col-6">
...
<?php echo $__env->make('teacher.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\zaidon\resources\views\teacher\previous_year_exams\create.blade.php ENDPATH**/ ?>