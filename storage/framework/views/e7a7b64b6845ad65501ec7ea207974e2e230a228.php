...
<?php $__env->startSection('title', __('messages.add_teacher')); ?>

<?php $__env->startSection('content'); ?>

<div class="page-header d-flex align-items-start justify-content-between flex-wrap gap-3">
    <div><h1 class="page-title"><?php echo e(__('messages.add_teacher')); ?></h1></div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" name="years_of_experience" value="<?php echo e(old('years_of_experience', 0)); ?>" min="0" class="form-control">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label"><?php echo e(__('messages.specialization_ar')); ?></label>
                        <input type="text" name="specialization_ar" value="<?php echo e(old('specialization_ar')); ?>" class="form-control" dir="rtl">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label"><?php echo e(__('messages.specialization_en')); ?></label>
                        <input type="text" name="specialization_en" value="<?php echo e(old('specialization_en')); ?>" class="form-control">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label"><?php echo e(__('messages.qualification_ar')); ?></label>
                        <input type="text" name="qualification_ar" value="<?php echo e(old('qualification_ar')); ?>" class="form-control" dir="rtl">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label"><?php echo e(__('messages.qualification_en')); ?></label>
                        <input type="text" name="qualification_en" value="<?php echo e(old('qualification_en')); ?>" class="form-control">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label"><?php echo e(__('messages.bio_ar')); ?></label>
                        <textarea name="bio_ar" rows="3" class="form-control" dir="rtl"><?php echo e(old('bio_ar')); ?></textarea>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label"><?php echo e(__('messages.bio_en')); ?></label>
                        <textarea name="bio_en" rows="3" class="form-control"><?php echo e(old('bio_en')); ?></textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="panel-card mb-3">
            ...
            <div class="panel-card-body">
                <div class="form-check form-switch mb-2">
                    <input class="form-check-input" type="checkbox" name="is_verified" value="1" id="is_verified" <?php echo e(old('is_verified') ? 'checked' : ''); ?>>
                    <label class="form-check-label" for="is_verified"><?php echo e(__('messages.verified_teacher')); ?></label>
                </div>
                ...
                <button type="submit" class="btn-primary-sm w-100 justify-content-center">
                    <i class="bi bi-save"></i> <?php echo e(__('messages.save_teacher')); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\zaidon\resources\views\admin\teachers\create.blade.php ENDPATH**/ ?>