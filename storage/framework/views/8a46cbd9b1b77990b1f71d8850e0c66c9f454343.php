...
<head>
    ...
    <title><?php echo e(__('messages.admin_login_title')); ?> — Ibn Zaidon</title>
...
<div class="l-panel">
    ...
    <div class="l-hero">
        ...
        <ul class="l-features">
            <li>
                ...
                <?php echo e(__('messages.feature_user_roles')); ?>

            </li>
            <li>
                <div class="feat-icon"><i class="bi bi-book-fill"></i></div>
                <?php echo e(__('messages.feature_courses_lessons')); ?>
    ...
    <div class="l-stats">
        <div class="l-stat">
            ...
            <span class="l-stat-lbl"><?php echo e(__('messages.students')); ?></span>
        </div>
        <div class="l-stat-divider"></div>
        <div class="l-stat">
            <span class="l-stat-val">94</span>
            <span class="l-stat-lbl"><?php echo e(__('messages.teachers')); ?></span>
        </div>
        <div class="l-stat-divider"></div>
        <div class="l-stat">
            <span class="l-stat-val">168</span>
            <span class="l-stat-lbl"><?php echo e(__('messages.courses')); ?></span>
        </div>
    </div>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="r-footer">
            &copy; <?php echo e(date('Y')); ?> Ibn Zaidon. <?php echo e(__('messages.all_rights_reserved')); ?>
...
<?php /**PATH C:\xampp\htdocs\zaidon\resources\views\admin\auth\login.blade.php ENDPATH**/ ?>