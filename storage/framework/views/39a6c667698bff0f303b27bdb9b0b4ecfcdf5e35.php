...
<div class="page-header d-flex align-items-start justify-content-between flex-wrap gap-3">
    <div><h1 class="page-title"><?php echo e(__('messages.edit_category')); ?>: <?php echo e($category->name_ar); ?></h1></div>
...
<div class="panel-card">
    <div class="panel-card-header"><h2 class="panel-card-title"><?php echo e(__('messages.category_details')); ?></h2></div>
    <div class="panel-card-body">
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="name_ar" value="<?php echo e(old('name_ar', $category->name_ar)); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="name_en" value="<?php echo e(old('name_en', $category->name_en)); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-8">
                ...
                <div class="input-group">
                    <span class="input-group-text">
                        <i id="iconPreview" class="bi <?php echo e($category->icon ?? 'bi-tag'); ?>"></i>
                    </span>
            ...
            <div class="col-md-4">
                ...
                <input type="number" name="order_index" value="<?php echo e(old('order_index', $category->order_index)); ?>"
                       min="0" class="form-control">
            </div>

            <div class="col-12">
                <?php if($category->image): ?>
                    <img src="<?php echo e(asset('assets/uploads/categories/' . $category->image)); ?>"
                         class="mb-2 rounded" style="width:80px;height:80px;object-fit:cover">
                <?php endif; ?>
                <label class="form-label d-block"><?php echo e(__('messages.category_image')); ?></label>
            ...
            <div class="col-12">
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" name="is_active" value="1"
                           id="is_active" <?php if(old('is_active', $category->is_active)): echo 'checked'; endif; ?>>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\zaidon\resources\views\admin\categories\edit.blade.php ENDPATH**/ ?>