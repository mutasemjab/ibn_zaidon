...
<?php $__env->startSection('title', __('messages.add_card')); ?>

<?php $__env->startSection('content'); ?>

<div class="page-header d-flex align-items-start justify-content-between flex-wrap gap-3">
    <div><h1 class="page-title"><?php echo e(__('messages.add_card')); ?></h1></div>
...
<form action="<?php echo e(route('admin.cards.store')); ?>" method="POST" enctype="multipart/form-data">
<?php echo csrf_field(); ?>
<div class="panel-card">
    <div class="panel-card-header"><h2 class="panel-card-title"><?php echo e(__('messages.card_info')); ?></h2></div>
...
unset($__errorArgs, $__bag); ?>">
                    ...
                    <option value="<?php echo e($pos->id); ?>" <?php if(old('pos_id') == $pos->id): echo 'selected'; endif; ?>>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-6">
                ...
                <input type="number" name="selling_price" value="<?php echo e(old('selling_price', 0)); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-6">
                ...
                <input type="number" name="number_of_cards" value="<?php echo e(old('number_of_cards', 10)); ?>"
                       min="1" max="1000" class="form-control <?php $__errorArgs = ['number_of_cards'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-6">
                ...
                <input type="number" name="code_length" value="<?php echo e(old('code_length', 16)); ?>"
                       min="8" max="32" class="form-control">
                <div class="form-text">الافتراضي 16 حرفاً.</div>
            </div>
            <div class="col-12">
                <label class="form-label"><?php echo e(__('messages.photo_label')); ?></label>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-12">
                ...
                <div class="d-flex flex-wrap gap-3 mt-1">
                    <label class="d-flex align-items-center gap-2 p-3 rounded border cursor-pointer activation-option <?php echo e(old('activation_type','price') === 'course'  ? 'border-primary' : ''); ?>" style="min-width:160px">
                        <input type="radio" name="activation_type" value="course"
                               <?php echo e(old('activation_type','price') === 'course' ? 'checked' : ''); ?>
                    ...
                    <label class="d-flex align-items-center gap-2 p-3 rounded border cursor-pointer activation-option <?php echo e(old('activation_type','price') === 'teacher' ? 'border-primary' : ''); ?>" style="min-width:160px">
                        <input type="radio" name="activation_type" value="teacher"
                               <?php echo e(old('activation_type','price') === 'teacher' ? 'checked' : ''); ?>
                    ...
                    <label class="d-flex align-items-center gap-2 p-3 rounded border cursor-pointer activation-option <?php echo e(old('activation_type','price') === 'price'   ? 'border-primary' : ''); ?>" style="min-width:160px">
                        <input type="radio" name="activation_type" value="price"
                               <?php echo e(old('activation_type','price') === 'price'   ? 'checked' : ''); ?>
            ...
            <div class="col-12" id="pick-course" style="<?php echo e(old('activation_type','price') === 'course' ? '' : 'display:none'); ?>">
...
unset($__errorArgs, $__bag); ?>">
                    ...
                    <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($c->id); ?>" <?php if(old('linked_course_id') == $c->id): echo 'selected'; endif; ?>>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-12" id="pick-teacher" style="<?php echo e(old('activation_type','price') === 'teacher' ? '' : 'display:none'); ?>">
...
unset($__errorArgs, $__bag); ?>">
                    ...
                    <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($t->id); ?>" <?php if(old('linked_teacher_id') == $t->id): echo 'selected'; endif; ?>>
                            <?php echo e($t->name); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\zaidon\resources\views\admin\cards\create.blade.php ENDPATH**/ ?>