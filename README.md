...
1. Set `APPLE_IAP_BUNDLE_ID=com.IbnZaidon.school` and
   `APPLE_IAP_COURSE_PRODUCT_PREFIX=com.IbnZaidon.school.course.v2.`. Each paid
   course must have a matching **Non-Consumable** product whose ID ends with
   the database course ID, for example `com.IbnZaidon.school.course.v2.42`.
